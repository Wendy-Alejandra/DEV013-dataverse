...
const data = [
  ...
  },
  {
    ...
    shortDescription: 'Harmony of the Seas ofrece una experiencia inigualable en cruceros. Descubre el entretenimiento mientras exploras destinos fascinantes en el Caribe.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/harmonyOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 362,
      shipClass: 'Clase Oasis',
  ...
  },
  {
    ...
    shortDescription: 'Explora el lujo en Oasis of the Seas que ofrece experiencias únicas y emocionantes destinos en todo el mundo.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/oasisOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 360,
      shipClass: 'Clase Oasis',
  ...
  },
  {
    ...
    shortDescription: 'Allure of the Seas ofrece una experiencia excepcional en cruceros. Descubre la diversión mientras exploras destinos emocionantes en el Caribe.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/allureOfTheSeasCanaveral.jpeg?raw=true',
    facts: {
      shipSize: 362,
      shipClass: 'Clase Oasis',
      visitingPorts: 'Port Canaveral, CocoCay, Nassau, Cozumel, Roatán, Falmouth',
  ...
  },
  {
    ...
    shortDescription: 'Embárcate en una aventura única con este crucero de Clase Quantum te lleva a destinos emocionantes.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/quantumOfTheSeasSingapure.jpeg?raw=true',
    facts: {
      shipSize: 347,
  ...
  },
  {
    ...
    shortDescription: 'Ofrece una experiencia única en cruceros. Descubre la diversión mientras exploras destinos emocionantes en Europa y América del Norte.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/anthemOfTheSeasSouthampton.jpeg?raw=true',
    facts: {
      shipSize: 348,
      shipClass: 'Clase Quantum',
  ...
  },
  {
    ...
    shortDescription: 'Embárcate en una aventura única con este crucero que te lleva a destinos emocionantes con comodidades de primer nivel.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/ovationOfTheSeasSydney.jpeg?raw=true',
    facts: {
      shipSize: 347,
      shipClass: 'Clase Quantum',
  ...
  },
  {
    ...
    shortDescription: 'Liberty of the Seas te invita a explorar la diversión en un crucero excepcional. Descubre emocionantes destinos en el Caribe.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/libertyOfTheSeasGalveston.jpeg?raw=true',
    facts: {
      shipSize: 339,
      shipClass: 'Clase Freedom',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/freedomOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 339,
      shipClass: 'Clase Freedom',
      visitingPorts: 'San Juan, Labadee, Falmouth, Día en el mar, Cozumel, Roatán',
  ...
  },
  {
    ...
    shortDescription: 'Embárcate en una aventura única con este crucero de Clase Voyager, lleva a destinos emocionantes con comodidades de primer nivel.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/adventurOfTheSeasAruba.jpeg?raw=true',
    facts: {
      shipSize: 311,
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/explorerOfTheSeasMiami.jpeg?raw=true',
    facts: {
      shipSize: 311,
      shipClass: 'Clase Voyager',
      visitingPorts: 'Miami, Día en el mar, San Juan, St. Thomas, St. Maarten, Antigua',
      departurePort: 'Miami',
      durationInDays: 7,
      cruisePrice: 1500,
  ...
  },
  {
    ...
    shortDescription: 'Embárcate en una experiencia inolvidable con este crucero te llevará a destinos fascinantes con comodidades de primera clase.',
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/navigatorOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 311,
      shipClass: 'Clase Voyager',
      visitingPorts: 'Miami, Labadee, Falmouth, Día en el mar, Cozumel, Roatán',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/marinerOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 311,
      shipClass: 'Clase Voyager',
      visitingPorts: 'Port Canaveral, CocoCay, Nassau, Día en el mar, Cozumel, Roatán',
      departurePort: 'Port Canaveral',
      durationInDays: 7,
      cruisePrice: 1550,
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/voyayerOfTheSeasSydney.jpeg?raw=true',
    facts: {
      shipSize: 311,
      shipClass: 'Clase Voyager',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/redianceOfTheSeasCanada.jpeg?raw=true',
    facts: {
      shipSize: 293,
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/billianceOfTheSeasBarcelona.jpeg?raw=true',
    facts: {
      shipSize: 293,
      shipClass: 'Clase Radiance',
      visitingPorts: 'Barcelona, Villefranche, La Spezia, Civitavecchia, Ajaccio',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/jewelOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 293,
      shipClass: 'Clase Radiance',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/spectrumOfTheSeasAsia.jpeg?raw=true',
    facts: {
      shipSize: 347,
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/serenadeOfTheSeasEurope.jpeg?raw=true',
    facts: {
      shipSize: 293,
      shipClass: 'Clase Radiance',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/visionOfTheSeasCaribe.jpeg?raw=true',
    facts: {
      shipSize: 279,
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/rhapsodyOfTheSeasEurope.jpeg?raw=true',
    facts: {
      shipSize: 279,
      shipClass: 'Clase Vision',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/grandeurOfTheSeasBaltimore.jpeg?raw=true',
    facts: {
      shipSize: 279,
      shipClass: 'Clase Vision',
  ...
  },
  {
    ...
    imageUrl: 'https://github.com/Wendy-Alejandra/DEV013-dataverse/blob/main/src/data/images/enchantmentOfTheSeasKeyWest.jpeg?raw=true',
    facts: {
      shipSize: 279,
      shipClass: 'Clase Vision',
      visitingPorts: 'Galveston, Key West, Día en el mar, Cozumel, Puerto Costa Maya',
      departurePort: 'Galveston',
      durationInDays: 7,
      cruisePrice: 1500,
